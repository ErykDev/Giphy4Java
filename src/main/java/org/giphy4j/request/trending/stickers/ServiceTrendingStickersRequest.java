...
/**
 * @author Eryk Szmyt
 * Requesting TrendingStickers Endpoint
 */
public final class ServiceTrendingStickersRequest extends MultiResultRequest {
    private int _Limit;
    ...
    protected String generateUrl() {
        HttpUrl.Builder urlBuilder = HttpUrl.parse("https://api.giphy.com/v1/stickers/trending").newBuilder();
